...
class Connection:
    def __init__(self, wanted_name):
        ...
        self.interpreter = tflite.Interpreter('DCLSTM_model_quant_edgetpu.tflite', experimental_delegates=[
            ...
            if self.connected:
                if self.slices_received == self.slices_required:  # send inference
                    try:
                        ...
                        # butterworth
                        inference_buf = filtfilt(
                            self.b, self.a, inference_buf, axis=0)
                        ...
                        self.num_inf += 1
                        print("iter:" + str(self.num_inf) + ", Proc:" + str(self.proc_sum / self.num_inf) + "Inf:" + str(
